  ...
  return (
    <div className=' mt-16 p-3 flex  items-center gap-6  justify-center overflow-x-auto'>
      {ServiceData.map((service) => (
        <div className='flex lg:h-28 lg:w-72 h-20 hover:bg-purple-100 shadow-md hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer items-center rounded-md bg-white  p-2' key={service.title}>
